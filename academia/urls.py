...
urlpatterns = [
    ...
    path("faculties/<str:school_code>", SchoolFacultyListAPIView.as_view(), name="get_faculties",),
    path("departments/<str:school_code>/<str:faculty_name>", DepartmentListAPIView.as_view(), name="get_departments",),
]
